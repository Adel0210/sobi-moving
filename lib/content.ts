...
export const CONTENT_DEFAULTS: SiteContent = {
  ...
  address: "Serving metro Atlanta from Sandy Springs, GA",
...
export const CONTENT_FIELDS: { group: string; key: string; label: string; multiline?: boolean }[] = [
  ...
  { group: "Business info", key: "address", label: "Service area (no street address: this is a service-area business)" },
